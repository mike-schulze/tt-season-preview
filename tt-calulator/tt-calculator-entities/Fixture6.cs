...
{
    public class Fixture6
    {
        public Fixture6(Team aTeam1, Team aTeam2)
        {
            Team1 = aTeam1;
            Team2 = aTeam2;
        ...
        {
            Matches.Add( new Match( Team1.Players[ 0 ], Team1.Players[ 1 ], Team2.Players[ 2 ], Team2.Players[ 3 ] ) );
            Matches.Add( new Match( Team1.Players[ 2 ], Team1.Players[ 3 ], Team2.Players[ 0 ], Team2.Players[ 1 ] ) );
            Matches.Add( new Match( Team1.Players[ 4 ], Team1.Players[ 5 ], Team2.Players[ 4 ], Team2.Players[ 5 ]) );
            ...
            Matches.Add( new Match( Team1.Players[ 4 ], Team2.Players[ 5 ]) );
            Matches.Add( new Match( Team1.Players[ 5 ], Team2.Players[ 4 ]) );
            ...
            Matches.Add( new Match( Team1.Players[ 4 ], Team2.Players[ 4 ] ) );
            Matches.Add( new Match( Team1.Players[ 5 ], Team2.Players[ 5 ] ) );
            ...
            {
                theMatch.Simulate();
                if( thePointsAway + thePointsHome < 16 || thePointsAway == 7 || thePointsHome == 7 )
                {
